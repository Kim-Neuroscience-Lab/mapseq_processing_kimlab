...
|--------|------------|-------------------|
| $N_0$ | True (latent) neuron population size | [Chapter 5](05_Statistical_Methods), [Chapter 10](10_Mathematical_Functions) |
| $N_{obs}$ | Observed neurons (project to ≥1 region) | [Chapter 5](05_Statistical_Methods) |
| $n$ | Number of target brain regions | [Chapter 5](05_Statistical_Methods) |
| $s_k$ | Neurons projecting to region k | [Chapter 5](05_Statistical_Methods) |
| $\pi$ | Detection probability | [Chapter 5](05_Statistical_Methods) |
| $p_e$ | Uniform edge probability (Model 1) | [Chapter 6](06_Probability_Models) |
| $p_i$ | Region-specific probability (Model 2) | [Chapter 6](06_Probability_Models) |
| $P(B\|A)$ | Conditional probability: B given A (Model 3) | [Chapter 6](06_Probability_Models) |
| $H$ | Entropy | [Chapter 10](10_Mathematical_Functions) |
| $JSD$ | Jensen-Shannon Divergence | [Chapter 10](10_Mathematical_Functions) |
| $\alpha$ | Significance threshold | [Chapter 5](05_Statistical_Methods) |
| $\alpha_{corrected}$ | Bonferroni-corrected threshold | [Chapter 5](05_Statistical_Methods) |
...
*For detailed information, refer to specific chapters. For mathematical details, see [Chapter 10: Mathematical Functions Reference](10_Mathematical_Functions).*
