...
**Independence:** Projections to different regions are statistically independent. This may not hold biologically if certain projection patterns co-occur—which is why we developed Model 3 (Correlated Binomial). See [Chapter 6: Probability Models](06_Probability_Models) for details.
...
*For probability model details, see [Chapter 6: Probability Models](06_Probability_Models). For mathematical formulas, see [Chapter 10: Mathematical Functions Reference](10_Mathematical_Functions).*
