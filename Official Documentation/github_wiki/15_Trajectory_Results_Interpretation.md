...
For directory layout and filenames, see [Chapter 8: Output Files and Structure](08_Output_Files_Interpretation). For statistical definitions of helper **07** transitions, see [Chapter 5: Statistical Methods](05_Statistical_Methods).
...
*Cross-anchor comparison at a conceptual level: [Chapter 16: Cross-Anchor Comparative Analysis](16_Cross_Anchor_Comparative_Analysis).*
