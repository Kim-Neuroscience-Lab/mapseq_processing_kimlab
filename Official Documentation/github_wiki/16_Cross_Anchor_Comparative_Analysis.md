...
For anchor-related **CLI flags**, see [Chapter 4: Main Processing Pipeline](04_Main_Processing_Pipeline). For trajectory file layouts, see [Chapters 8](08_Output_Files_Interpretation) and [15](15_Trajectory_Results_Interpretation).
...
- **Few time points** make monotonic trend statistics brittle; see [Chapter 15](15_Trajectory_Results_Interpretation).
...
*For stability framing without dataset-specific verdicts, see [Chapter 11: Stability Analysis](11_Stability_Analysis).*
