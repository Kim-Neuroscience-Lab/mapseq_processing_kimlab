...
*For detailed usage instructions, see [Chapter 4: Main Processing Pipeline](04_Main_Processing_Pipeline). For output paths and columns, see [Chapter 8: Output Files and Structure](08_Output_Files_Interpretation).*
